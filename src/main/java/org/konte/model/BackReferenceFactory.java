...
public class BackReferenceFactory {
    ...
    public static Name newBackReference(Token token, final Model modl) throws ParseException {
            ...
            return new Name() {
                ...
                public Float evaluate() throws ParseException {
                    ...
                    try {
                        ...
                        throw new ParseException(String.format("error evaluating 'imgr': no 'img' with index [%s]",
                                img));
                    }
                }
            };
            ...
            return new Name() {
                ...
                public Float evaluate() throws ParseException {
                    ...
                    try {
                        ...
                        throw new ParseException(String.format("error evaluating 'imgg': no 'img' with index [%s]",
                                img));
                    }
                }
            };
            ...
            return new Name() {
                ...
                public Float evaluate() throws ParseException {
                    ...
                    try {
                        ...
                        throw new ParseException(String.format("error evaluating 'imgb': no 'img' with index [%s]",
                                img));
                    }
            ...
            return new Name() {
                ...
                public Float evaluate() throws ParseException {
                    ...
                    try {
                        ...
                        throw new ParseException(String.format("error evaluating 'imga': no 'img' with index [%s]",
                                img));
                    }
                }
            };
