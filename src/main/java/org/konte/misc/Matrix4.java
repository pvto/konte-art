...
/**<p>Modified under from org.sunflow.math.Matrix4.
 * 
...
public final class Matrix4 implements Serializable {
    ...
    public static final transient Matrix4 ZERO = new Matrix4();
    public static final transient Matrix4 IDENTITY = Matrix4.scale(1);
    ...
    public final static Matrix4 translation(float x, float y, float z) {
        return new Matrix4(1f, 0f, 0f, x, 0f, 1f, 0f, y, 0f, 0f, 1f, z, 0f, 0f, 0f, 1f);
    }
    ...
    public final static Matrix4 FLIPX = new Matrix4(1f, 0f, 0f, 0f, 0f, -1f, 0f, 0f, 0f, 0f, -1f, 0f, 0f, 0f, 0f, 1f);
    public final static Matrix4 FLIPY = new Matrix4(-1f, 0f, 0f, 0f, 0f, 1f, 0f, 0f, 0f, 0f, -1f, 0f, 0f, 0f, 0f, 1f);
    public final static Matrix4 FLIPZ = new Matrix4(-1f, 0f, 0f, 0f, 0f, -1f, 0f, 0f, 0f, 1f, 0f, 0f, 0f, 0f, 0f, 1f);

    public static Matrix4 skew(float fx, float fy, float fz) {
        return new Matrix4(1f, fx, fx, 0f,
                fy, 1f, fy, 0f,
                fz, fz, 1f, 0f,
                0f, 0f, 0f, 1f);
    }

    public static Matrix4 flipX(float f) {
        return FLIPX.multiply(rotateX(f));
    }

    public static Matrix4 flipY(float f) {
        return FLIPY.multiply(rotateY(f));
    }

    public static Matrix4 flipZ(float f) {
        return FLIPZ.multiply(rotateZ(f));
    }
